...
export default function CreateFRQPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await examApi.createFRQQuestion({
      ...
      alert('FRQ question created successfully!');
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h1 className="text-4xl font-bold text-white">Create FRQ Question</h1>
              </div>
              <p className="text-indigo-100 text-lg">Design a professional AP Computer Science A Free Response Question</p>
            </div>
            <Button
              type="button"

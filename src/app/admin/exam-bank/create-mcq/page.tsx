...
import { ArrowLeft, Save, Eye, X, CheckCircle2, XCircle } from 'lucide-react';
...
export default function CreateMCQPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await examApi.createMCQQuestion({
      ...
      alert('MCQ question created successfully!');
    ...
    <div className="max-w-4xl mx-auto space-y-6 pb-12">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Create MCQ Question</h1>
            <p className="text-gray-600 mt-1">Add a new multiple choice question to the exam bank</p>
          </div>
        </div>
        <Button
          type="button"
